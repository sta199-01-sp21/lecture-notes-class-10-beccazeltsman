...
- What is the probability a randomly selected patient received the placebo and had a marked improvement? -conditional
7/84
  
- What is the probability a randomly selected patient received the placebo and the treatment? - disjoint
0
...
This is very close to the "true" probability. An example of the law of large numbers - each proportion is extremely close.
...
It is a small probability/ unlikely to get two colors at the same time
